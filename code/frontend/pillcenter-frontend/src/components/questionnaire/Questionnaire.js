            ...
            <Grid item={true} xs={25} sm={20}>
              <FormControl component="fieldset" sx={{ textAlign: "left" }}>
                <RadioGroup
                  ...
                  onChange={handleQuestionChange}
                >
                  האם יש לך מצבים רפואיים כגון הריון,הנקה,מחלת כבד או כליות,מחלת
                  לב שעלולה להצביע נגד שימוש בתרופות מסוימות?
                  <FormControlLabel value="כן" control={<Radio />} label="כן" />
                  <FormControlLabel value="לא" control={<Radio />} label="לא" />
                </RadioGroup>
            ...
            <Grid item={true} xs={25} sm={20}>
              ...
              <FormControl component="fieldset" sx={{ textAlign: "left" }}>
                <RadioGroup
                  ...
                  onChange={handleQuestionChange}
                >
                  לאלו תסמינים או מצבים אתה מחפש טיפול? נא לתאר אותם בפירוט,כולל
                  משך הזמן והחומרה:
                  <TextField
                    id="standard-basic"
                    sx={{ m: 1, width: "80%", height: "10%" }}
                  />
                </RadioGroup>
              </FormControl>
            </Grid>
